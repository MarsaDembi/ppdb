...
<body x-data="{ page: 'signin', 'darkMode': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
    ...
    <main>
        ...
        <section class="i pg fh rm ki xn vq gj qp gr hj rp hr">
            ...
            <div class="animate_top bb af i va sg hh sm vk xm yi _n jp hi ao kp">
                ...
                <!-- FORM LOGIN -->
                <form class="sb" action="{{ route('proses_signin') }}" method="POST">
                    @csrf
                    <div class="wb">
