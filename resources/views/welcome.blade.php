  ...
  <header class="g s r vd ya cj" :class="{ 'hh sm _k dj bl ll' : stickyMenu }"
    ...
    <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
      <div class="vd to/4 tc wf yf">
        <a href="index.html">
          <!-- Logo Light -->
<span class="om text-3xl font-extrabold tracking-widest bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-md">
  PKBM <span class="text-white">Bela Warga</span>
</span>

<!-- Logo Dark -->
<span class="xc nm text-3xl font-extrabold tracking-widest bg-gradient-to-r from-yellow-400 via-green-500 to-blue-500 bg-clip-text text-transparent drop-shadow-lg">
  PKBM <span class="text-gray-200">Bela Warga</span>
      ...
      <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
        ...
        <div class="tc wf ig pb no">
          ...
          <a href="/signin" :class="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }"
            class="ek pk xl">SignIn</a>
          <a href="/signup" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }"
  ...
  <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
    <img src="{{asset('asset/images/shape-01.svg')}}" alt="shape" class="xc 2xl:ud-block h t -ud-left-[10%] ua" />
  ...
  <!-- Section Title Start -->
  <div
    x-data="{ sectionTitle: `Pilihan Program Pendidikan Kesetaraan`, sectionTitleText: `PKBM Bela Warga menyediakan layanan Paket A, Paket B, dan Paket C untuk membantu masyarakat menuntaskan pendidikan formal.`}">
  ...
  <div class="bb ze ki xn yq mb en">
    <div class="wc qf pn xo ng">
      ...
      <div class="animate_top sg oi pi zq ml il am cn _m">
        ...
        <p>Pendidikan lanjutan untuk lulusan Paket A atau yang belum menempuh pendidikan menengah pertama.</p>
      </div>
      ...
      <div class="animate_top sg oi pi zq ml il am cn _m">
        ...
        <p>Kesempatan menyelesaikan pendidikan menengah atas, sebagai bekal melanjutkan studi atau bekerja.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="tentangkami" class="ji gp uq 2xl:ud-py-35 pg">
  ...
  <h2 class="fk vj zp pr kk wm qb">Pusat Kegiatan Belajar Masyarakat untuk Pendidikan Kesetaraan</h2>
  <p class="uo">
    PKBM Bela Warga hadir sebagai lembaga pendidikan nonformal yang berfokus pada layanan kesetaraan Paket A, B, dan C. 
    Selain itu, PKBM ini juga menyelenggarakan berbagai program keterampilan dan pemberdayaan masyarakat untuk mendukung peningkatan kualitas hidup warga.
  </p>
  ...
  <div class="bb ze ki yn 2xl:ud-px-12.5 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="tc uf zo xf ap zf bp mq grid grid-cols-1 md:grid-cols-4 gap-8">
      <div class="animate_top kn to/3 tc cg oq p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transform hover:scale-[1.02]">
        <div class="tc wf xf cf ae cd rg mh flex items-center justify-center w-16 h-16 rounded-full mb-4 bg-blue-100 dark:bg-blue-900 mx-auto">
          <img src="{{asset('asset/images/icon-05.svg')}}" alt="Pendidikan Kesetaraan" class="w-8 h-8"/> 
        </div>
        <div class="text-center">
          <h4 class="ek yj go kk wm xb text-xl font-extrabold mb-2 text-blue-600 dark:text-blue-400">Pendidikan Kesetaraan Lengkap</h4>
         <p class="text-base text-gray-600 dark:text-gray-400 mt-3">Menyediakan Paket A, B, dan C bagi masyarakat yang ingin menuntaskan pendidikan formal.</p>
    </div>
      </div>
      <div class="animate_top kn to/3 tc cg oq p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transform hover:scale-[1.02]">
        <div class="tc wf xf cf ae cd rg nh flex items-center justify-center w-16 h-16 rounded-full mb-4 bg-green-100 dark:bg-green-900 mx-auto">
          <img src="{{asset('asset/images/icon-06.svg')}}" alt="Fleksibilitas" class="w-8 h-8" />
        </div>
        <div class="text-center">
          <h4 class="ek yj go kk wm xb text-xl font-extrabold mb-2 text-green-600 dark:text-green-400">Waktu Belajar Fleksibel</h4>
         <p class="text-base text-gray-600 dark:text-gray-400 mt-3">Disesuaikan dengan kebutuhan peserta, cocok untuk pekerja, orang tua, maupun masyarakat umum.</p>
        </div>
      </div>
    
      <div class="animate_top kn to/3 tc cg oq p-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transform hover:scale-[1.02]">
        <div class="tc wf xf cf ae cd rg oh flex items-center justify-center w-16 h-16 rounded-full mb-4 bg-yellow-100 dark:bg-yellow-900 mx-auto">
          <img src="{{asset('asset/images/icon-04.svg')}}" alt="Inklusif" class="w-8 h-8" />
        </div>
        <div class="text-center">
          <h4 class="ek yj go kk wm xb text-xl font-extrabold mb-2 text-yellow-600 dark:text-yellow-400">Inklusif & Terjangkau</h4>
         <p class="text-base text-gray-600 dark:text-gray-400 mt-3">Terbuka untuk semua kalangan dengan biaya ramah masyarakat atau dukungan program pemerintah.</p>
</div>
      </div>
    </div>
  </div>
    ...
    <section id="kontak" class="i pg fh rm ji gp uq">
      ...
      <!-- Section Title Start -->
      <div
  x-data="{ sectionTitle: `Mari Mengenal PKBM Bela Warga`, sectionTitleText: `Hubungi Kami untuk Informasi Lebih Lanjut` }">
  <div class="animate_top bb ze rj ki xn vq">
